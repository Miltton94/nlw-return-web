...
interface FeedbackSuccessStepProps {
  feedbackSent: (feedbackSent: boolean) => void;
}
const FeedbackSuccessStep = ({ feedbackSent }: FeedbackSuccessStepProps) => {
  return (
    <>
      <header>
        <CloseButton />
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <button
          ...
          className=" mt-6 mb-10 py-2 px-6 bg-zinc-800 rounded hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-violet-500 disabled:opacity-50 disabled:hover:bg-violet-500">
          Quero enviar outro
        </button>
      </div>
    </>
